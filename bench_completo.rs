...
fn main() {
    ...
    println!(
        "  {:<28} {:>10} {:>10}",
        "Implementacion", "us/iter", "vs Python"
    );
    println!("  {:─<28} {:─>10} {:─>10}", "", "", "");
...
"#,
    ...
    let build = Command::new("go")
        .args(&["build", "-o", "bench_go_test.exe", "bench_go_test.go"])
        .output();
    match build {
